...
## Для основной формулы модели

Построим два фазовых портрета для выбранных раннее коэффициентов и численностей популяций $x_0=2.5$, $y_0=4$ для первого случая (а) и $x_0=2$, $y_0=4$ для второго случая (б) (рис. [-@fig:007]). 
...
## Для формулы с фактором насыщения

Построим фазовые портреты для численностей популяций от 0 до 20 (рис. [-@fig:008]). На графике а) мы видим множество линий, с помощью которых можно увидеть, при каких численностях популяции будут расти или сокращаться. Для удобства понимания на графике б) представлена упрощенная версия первого графика с указанием направлений: перебираются варианты $x_0=20$, $y_0=[0, 20]$ и $y_0=20$ $x_0=[0, 20]$.

![Фазовые портреты для формулы с насыщением](image/8.png){#fig:008 width=90%}


## Для формулы с фактором внутривидовой конкуренции
